/* importing the materials UI of button and textfield. 
Importing package react, auth from firebase , Signup from sign up file and styles 
*/
...
/* setting catch block for wrong email and password which prevent the user to enter the Application page.
*/
  const signin = (e) => {
    e.preventDefault();
    setLoading(true);
      ...
      {showSignup ? (
        ...
        <div className="login__content">
          ...
          <div className={`login__wrapper ${loading && "login__fade"}`}>
            ...
            <p className="login__subtitle">Continue to Microsoft</p>
