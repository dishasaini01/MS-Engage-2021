...
importing material UI for Avatar, Badge, Button, makeStyles, Popover,Apps, CameraAltOutlined, 
FeedbackOutlined, HelpOutline, PersonAddOutlined, Settings.

importing files useAppContext which we have declared in context folder and styles file in which we have
applied styles.

Importing auth from Firebase for the user to be able to login and signup.
*/
...
//initializing Header for the header page which pops up on clicking the i button on topmost right corner of home page. 
